...
const messages = [
    ...
    "Hay Dina Rahma Febriana ❤️",
    "Vino nak ngomong sesuatu nah😁",
    "Coba pencet",
    "❤️05 Februari 2025❤️",
    "HappyBirthday Buat Dina 🎁🎈",
    "Semoga Panjang Umur😍🥳,",
    "Sehat Selalu..",
    "Sukses Terus Dalam Hal Apapun..",
    "Selalu Sayang Sama Keluarga, Dan...",
    "Selalu Sayang Jugo samo Vino wkwkwkw 🥰🥰",
    "Ohiyo...Semangat yo Skripsi nyo💪....",
    "Semoga cepet Selesai, Dan Biso Cepet Wisuda🎓",
    "Kadonyo Nyusul yee🤪",
    "Pencet Terus...",
    "Sekali Lagi😃",
    "Vino Ado Pantun Untuk Dina😝",
    "kepasar beli Tanah pulangnya makan kadal",
    "i love you Dina❤️",
    "Hahahahha ",
    "Cubo pencet tombol dibawah ini 💝"
];
